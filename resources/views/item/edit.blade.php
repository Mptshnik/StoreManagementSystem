...
@section('content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <div class="h3 col-auto">Изменение товара {{$item->name}}</div>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input value="{{$item->number}}" type="text" class="form-control" name="number"
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" class="form-control" name="description"
                                      placeholder="Описание товара">{{$item->description}}</textarea>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input value="{{$item->price_per_unit}}" type="text" class="form-control"
                                           name="price_per_unit"
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input value="{{$item->base_price_per_unit}}" type="text" class="form-control"
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input value="{{$item->quantity}}" type="text" class="form-control" name="quantity"
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input value="{{$item->discount}}" type="text" class="form-control" name="discount"
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="select2" name="categories[]" multiple="multiple"
                                        ...
                                        @foreach($categories as $category)
                                            <option
                                                @if(isset($data['categories']) && in_array($category->slug, $data['categories'])
                                                || $item->categories->contains($category)) selected
                                                @endif value="{{$category->slug}}">
                                                {{$category->name}}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="manufacturer_id"
                                        ...
                                        @foreach($manufacturers as $manufacturer)
                                            ...
                                            <option @if( $manufacturers->contains($item->manufacturer)) selected
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div id="image_output_container" style="display: flex;">
                                    <div class="parent mt-2">
                                        <img class="mb-1" height="150px" id="output_preview_image"
